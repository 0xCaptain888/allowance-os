...
Allowance OS v0.16.0 includes a reference TypeScript SDK for bounded repeat payments plus a live AlphaBrief delivery verifier and Devnet commercial runner. It is intentionally signer-agnostic: wallet credentials stay in Mobile Wallet Adapter, Seed Vault, or an application-controlled signer adapter.
